package maxhyper.dthexerei.canceller;
...
public class HexereiTreeFeatureCanceller<T extends FeatureConfiguration> extends TreeFeatureCanceller<T> {

    private final Class<T> treeFeatureConfigClass;

    public HexereiTreeFeatureCanceller(final ResourceLocation registryName, Class<T> treeFeatureConfigClass) {
